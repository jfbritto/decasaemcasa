...
<div class="min-h-screen bg-gradient-to-b from-amber-50 to-white py-8" x-data="inscriptionForm()">
    ...
    <form method="POST" action="<?php echo e(route('inscricao.store')); ?>" @submit="handleSubmit($event)">
        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="ml-4 flex-1">
                                        <div class="flex items-center justify-between">
                                            <span class="text-lg font-semibold text-gray-900">
                                                <?php echo e($event->city ?? $event->title); ?>

                                            </span>
                                            <span class="text-sm font-medium text-indigo-600">
                                                <?php echo e($event->date->format('d/M')); ?>

                                            </span>
                                        </div>
                                        <?php if($event->title && $event->city && $event->title !== $event->city): ?>
                                            <p class="text-sm text-gray-500 mt-1"><?php echo e($event->title); ?></p>
                                        <?php endif; ?>
                                        <?php if($event->capacity > 0): ?>
                                            <p class="text-xs mt-1 <?php echo e($event->isFull() ? 'text-red-500' : 'text-gray-400'); ?>">
                                                <?php if($event->isFull()): ?>
                                                    Vagas esgotadas
                                                <?php else: ?>
                                                    <?php echo e($event->available_spots); ?> <?php echo e($event->available_spots === 1 ? 'vaga' : 'vagas'); ?> restante<?php echo e($event->available_spots === 1 ? '' : 's'); ?>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="full_name" id="full_name" x-model="formData.full_name"
                                   ...
                                   placeholder="Seu nome completo" value="<?php echo e(old('full_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="cpf" id="cpf" x-model="formData.cpf"
                                   ...
                                   maxlength="14"
                                   class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-4 py-3"
                                   placeholder="000.000.000-00" value="<?php echo e(old('cpf')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="city_neighborhood" id="city_neighborhood" x-model="formData.city_neighborhood"
                                   class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-4 py-3"
                                   placeholder="Ex: Savassi, Belo Horizonte" value="<?php echo e(old('city_neighborhood')); ?>">
                            <p class="mt-1 text-xs text-gray-500">Essencial para a logística da turnê.</p>
                            <?php $__errorArgs = ['city_neighborhood'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="whatsapp" id="whatsapp" x-model="formData.whatsapp"
                                       ...
                                       maxlength="15"
                                       class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-4 py-3"
                                       placeholder="(00) 00000-0000" value="<?php echo e(old('whatsapp')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="instagram" id="instagram" x-model="formData.instagram"
                                   class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-4 py-3"
                                   placeholder="@seuusuario" value="<?php echo e(old('instagram')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="motivation" id="motivation" x-model="formData.motivation"
                                      rows="5"
                                      class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-4 py-3"
                                      placeholder="Conte-nos um pouco sobre você e por que deseja fazer parte desse encontro..."><?php echo e(old('motivation')); ?></textarea>
...
function inscriptionForm() {
    return {
        step: <?php echo e($errors->any() ? 3 : 1); ?>,
        formData: {
            event_id: '<?php echo e(old("event_id", "")); ?>',
            full_name: '<?php echo e(old("full_name", "")); ?>',
            cpf: '<?php echo e(old("cpf", "")); ?>',
            birth_date: '<?php echo e(old("birth_date", "")); ?>',
            city_neighborhood: '<?php echo e(old("city_neighborhood", "")); ?>',
            whatsapp: '<?php echo e(old("whatsapp", "")); ?>',
            email: '<?php echo e(old("email", "")); ?>',
            instagram: '<?php echo e(old("instagram", "")); ?>',
            motivation: `<?php echo addslashes(old("motivation", "")); ?>`,
            terms_accepted: <?php echo e(old("terms_accepted") ? 'true' : 'false'); ?>,
        },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/inscriptions/create.blade.php ENDPATH**/ ?>