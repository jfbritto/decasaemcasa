<?php $__env->startSection('subject', 'Fila de Espera - De Casa em Casa'); ?>
...
<p style="margin:0; color:#5c584f; font-size:15px; line-height:1.7;">
    Vamos manter seu contato em nossa <strong style="color:#9a3412;">Fila de Espera</strong> — caso haja alguma desistência ou uma nova data por perto, avisaremos você.
</p>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('emails.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/emails/inscription-waitlisted.blade.php ENDPATH**/ ?>