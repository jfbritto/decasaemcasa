...
<head>
    ...
    <title><?php echo $__env->yieldContent('subject', 'De Casa em Casa'); ?></title>
    <!--[if mso]>
    <noscript>
        <xml>
        ...
        <tr>
            <td align="center">
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <!-- Status Badge -->
                    <?php if (! empty(trim($__env->yieldContent('badge')))): ?>
                    <tr>
                        <td align="center" style="padding:24px 40px 0;">
                            <?php echo $__env->yieldContent('badge'); ?>
                        </td>
                    </tr>
                    <?php endif; ?>
                    ...
                    <!-- Event Info Box -->
                    <?php if (! empty(trim($__env->yieldContent('event_info')))): ?>
                    <tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8f7f4; border-radius:10px; border:1px solid #e8e5de;">
                                <tr>
                                    <td style="padding:20px 24px;">
                                        <?php echo $__env->yieldContent('event_info'); ?>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <!-- CTA Button -->
                    <?php if (! empty(trim($__env->yieldContent('cta_url')))): ?>
                    <tr>
                        <td align="center" style="padding:0 40px 32px;">
                            <a href="<?php echo $__env->yieldContent('cta_url'); ?>" target="_blank" style="display:inline-block; background:linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); color:#ffffff; text-decoration:none; padding:14px 36px; border-radius:8px; font-size:15px; font-weight:600; letter-spacing:0.3px;">
                                <?php echo $__env->yieldContent('cta_text', 'Acompanhar Inscrição'); ?>
                            </a>
                        </td>
                    </tr>
                    <?php endif; ?>
...
<?php /**PATH /var/www/resources/views/emails/layout.blade.php ENDPATH**/ ?>