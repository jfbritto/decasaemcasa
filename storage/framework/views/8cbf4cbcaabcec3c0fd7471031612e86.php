                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 2px 16px rgba(26,46,110,0.10);">
                    ...
                    <tr>
                        <td align="center" style="padding:0 40px 32px;">
                            <a href="<?php echo $__env->yieldContent('cta_url'); ?>" target="_blank" style="display:inline-block; background-color:#e88a2d; color:#ffffff; text-decoration:none; padding:14px 36px; border-radius:8px; font-size:15px; font-weight:700; letter-spacing:0.3px;">
