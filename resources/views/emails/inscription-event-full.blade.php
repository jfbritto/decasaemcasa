...
@section('subject', 'Vagas esgotadas - De Casa em Casa')

@section('badge')
<span style="display:inline-block; background-color:#fff7ed; color:#9a3412; padding:6px 20px; border-radius:20px; font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:1px;">
    Vagas Esgotadas
</span>
@endsection
...
<p style="margin:0 0 16px; color:#4a4639; font-size:15px; line-height:1.7;">
    Recebemos sua história e ficamos muito felizes com o seu interesse em participar do encontro <strong>De Casa em Casa</strong> em <strong>{{ $event->city }}</strong>.
</p>
<p style="margin:0 0 16px; color:#4a4639; font-size:15px; line-height:1.7;">
